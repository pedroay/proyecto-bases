...
BEGIN
    ...
    BEGIN
        BEGIN
            ...
            VALUES (101010101, 'CC', 'Doc', 'Base', 'doc@base.com');
    ...
    BEGIN
        ...
        DBMS_OUTPUT.PUT_LINE('FALLO 1: La operacion deberia haber fallado (CHK_TIPO_DOC_VALIDO).');
    EXCEPTION
        WHEN OTHERS THEN
            DBMS_OUTPUT.PUT_LINE('EXITO 1: Capturado: ' || SQLERRM);
    END;
    ...
    BEGIN
        ...
        DBMS_OUTPUT.PUT_LINE('FALLO 2: La operacion deberia haber fallado (trg_check_doctor_area).');
    EXCEPTION
        WHEN OTHERS THEN
            -- Esperamos el error -20001 lanzado por el trigger
            DBMS_OUTPUT.PUT_LINE('EXITO 2: Capturado: ' || SQLERRM);
    END;
    ...
    BEGIN
        ...
        DBMS_OUTPUT.PUT_LINE('FALLO 3: La operacion deberia haber fallado (FK_ENFERMERA_PERSONA).');
    EXCEPTION
        WHEN OTHERS THEN
            -- Esperamos ORA-02291: integrity constraint violated - parent key not found
            DBMS_OUTPUT.PUT_LINE('EXITO 3: Capturado: ' || SQLERRM);
    END;
